/**
 * Room Management JavaScript - Receptionist Isolated Version
...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    // Update Sidebar Navigation based on Role - Receptionist Version
    // Since this is a dedicated file, we can prioritize the receptionist sidebar
...
function updateSidebarForRole(role) {
    ...
    // We can leave others as fallback or just empty since this page is primarily for receptionists
}
